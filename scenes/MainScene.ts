...
import { HeroCharacter, createParticleEmitter } from '../objects/HeroCharacter';
import * as TWEEN from "@tweenjs/tween.js";
import { WorldP2 } from '../objects/WorldP2';
import { StatType } from '../objects/PlayerStats';
...
export class MainScene extends Scene {
    ...
    public onUpdate(dt: number) {
        ...
        (this.HudOverlay as Scene).onUpdate(dt);
